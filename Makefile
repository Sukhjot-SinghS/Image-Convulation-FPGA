...
# Added 'all' to the phony list
.PHONY: all help clean $(PROGRAMS)
...
all: $(PROGRAMS)
	@echo "==========================================================="
	@echo " ALL PROGRAMS COMPILED AND PROCESSED SUCCESSFULLY!"
	@echo "==========================================================="
...
help:
	...
	@echo ""
	@echo " Utilities:"
	@echo "   make all      - Compiles and runs every program in the list sequentially"
	@echo "   make clean    - Wipes all compiled files and simulation logs"
	@echo "==========================================================="
