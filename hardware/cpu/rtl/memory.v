...
module instr_mem (
	...
	initial begin
//		$readmemh("C:/Image_convulation_project/Image-Convulation-FPGA/hardware/cpu/imem.hex", imem);
...
module data_mem (
	...
	initial begin
//    	$readmemh("C:/Image_convulation_project/Image-Convulation-FPGA/hardware/cpu/dmem.hex", dmem);
