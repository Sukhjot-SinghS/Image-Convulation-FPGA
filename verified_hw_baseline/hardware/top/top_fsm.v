...
module top_fsm #(
    ...
    // ΓöÇΓöÇ Physical UART pins ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    input  wire        rx_pin,      // UART RX from PC
    output wire        tx_pin,      // UART TX to PC

    // ΓöÇΓöÇ CPU pipeline interface (from pipeline.v) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    ...
    // ΓöÇΓöÇ Benchmark cycle counter (from top_fpga.v) ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
    input  wire [31:0] cycle_count  // frozen cycle count for UART TX
);

// ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
//  Reset ΓÇö UART needs active HIGH, rest of design active LOW
// ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
                ...
                TX_WAIT_DONE: begin
                    if (tx_done) begin
                        if (tx_byte_count < 14'd15875) begin
                            ...
                            // Last image byte done ΓåÆ start cycle-count phase
                            tx_byte_count  <= 14'd15876;
                            cycle_byte_sel <= 2'd0;
                            tx_fsm         <= TX_SEND_CYCLES;
                        end
                        else if (tx_byte_count < 14'd15879) begin
                            // Intermediate cycle-count byte done ΓåÆ next one
                            tx_byte_count <= tx_byte_count + 14'd1;
                            tx_fsm        <= TX_SEND_CYCLES;
                        end
